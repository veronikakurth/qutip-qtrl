You are most welcome to contribute to qutip-qtrl development by forking this repository and sending pull requests, or filing bug reports at the [issues page](https://github.com/qutip/qutip-qtrl/issues).
...
By submitting a contribution to qutip-qtrl, you agree to
...
- **Stance on Good First Issues:** The main purpose of a “good first issue” is to allow new human contributors to get familiar with `qutip-qtrl`, with the GitHub workflow and to engage with the community. Submitting a fully AI-generated PR defeats that purpose. AI can be used as a learning aid to understand the codebase, but the final implementation must be your own.
